...
<template>
    <footer class="bg-darkmode relative z-1 border-t border-dark_border px-6">
            ...
            <div class="grid md:grid-cols-12 grid-cols-1 sm:grid-cols-12">
                ...
                <div
                    ...
                    <div class="flex flex-col md:items-start items-center">
                        <span class="text-lg font-bold text-white pb-4 inline-block">{{ t('footer.directContact.title') }}</span>
                        <p class="text-white/50 text-base pb-5 max-w-xs md:text-start text-center">
                            {{ t('footer.directContact.subtitle') }}
                        </p>
                        ...
                        <div>
                            <ul class="flex items-center gap-3 mt-[1.875rem]">
                                <!-- Facebook -->
                                <li class="group">
                                    <a :href="t('footer.directContact.rrss.facebook')">
                                ...
                                <!-- Twitter -->
                                <li class="group">
                                    <a :href="t('footer.directContact.rrss.x')">
                                ...
                                <!-- LinkedIn -->
                                <li class="group">
                                    <a :href="t('footer.directContact.rrss.linkedin')">
        ...
        <div class="text-center gap-4 md:gap-0 flex-wrap p-7 border-t border-solid border-dark_border">
            ...
            <div>
                <p class="text-base text-white/50">{{ t('footer.text') }}</p>
            </div>
        </div>
    </footer>
</template>